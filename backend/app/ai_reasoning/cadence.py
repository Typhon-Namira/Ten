...
AI_ANALYSIS_TIMEFRAMES = frozenset({"M5", "M15"})
AI_ANALYSIS_TIMEFRAME = "M5_M15"
...
def synchronized_cycle_eligibility(
    ...
    if (
        state.trigger_timeframe.upper() not in AI_ANALYSIS_TIMEFRAMES
    ...
    if set(frames) != AI_ANALYSIS_TIMEFRAMES:
