...
def build_market_intelligence(
    *,
    ...
    return {
        ...
        "market_status": session.market_status.value if session else "UNKNOWN",
        "market_status_source": session.status_source if session else "unavailable",
        "market_timezone": session.timezone if session else "America/New_York",
        "market_closure_reason": session.closure_reason if session else "schedule_unavailable",
